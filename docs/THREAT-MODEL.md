...
- Unit specs: SSRF guard allow/deny table; parser length-cap behavior; malformed-input matrix; unstorable response headers (ETag, out-of-range rate integers)
